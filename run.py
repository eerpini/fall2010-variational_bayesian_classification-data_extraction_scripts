...
print "Running with Bin Size : " + str(bin_size)
j=0
...
#		print str(total_count) + "  ",
	...
	if error_count > total_count :
		print "Error occurred in Iteration "+str(i)+", check again"
		sys.exit(1)
	else:
		print "Iteration "+str(j+1)+" : "+str(error_count/total_count)
	total_error = total_error + error_count
	j = j+1
print "Bin Size : "+str(bin_size)+"   Average Error : "+str(total_error/(num_iterations*total_count))
